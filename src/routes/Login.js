            ...
            <div class="flex-1 bg-white sm:h-screen flex items-center justify-center rounded-r-[6%]">
                <div class="mx-[20%] my-[25%]">
                    ...
                    <form class="flex flex-col gap-4 justify-center items-center">
                        ...
                        <div className="mt-3 text-center text-black text-opacity-70 font-medium bg-gray-100 p-4 rounded-lg shadow-md">
                            <p className="text-xl">Access Restricted</p>
                            <p className="text-base">This page is for administrators only.</p>
                        </div>
                    </form>
                </div>
            </div>
